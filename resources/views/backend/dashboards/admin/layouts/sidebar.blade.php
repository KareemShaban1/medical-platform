...
@endhasPermission -->
            ...
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#sidebarClinicsManagement" aria-expanded="false"
                    aria-controls="sidebarClinicsManagement" class="side-nav-link">
            ...
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#sidebarSuppliersManagement" aria-expanded="false"
                    aria-controls="sidebarSuppliersManagement" class="side-nav-link">
                    <i class="uil-users-alt"></i>
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarUsersManagement">
                    <ul class="side-nav-second-level">
                        ...
                        <!-- Carousels -->
                        <li class="side-nav-item">
                            <a href="{{ route('admin.carousels.index') }}" class="side-nav-link">
                                <i class="uil-images"></i>
                                <span> {{ __('Carousels') }} </span>
                            </a>
                        </li>

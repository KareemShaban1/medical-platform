...
<div class="leftside-menu">
	...
	<!-- Users Management -->
	@hasAnyPermission('view system management', 'view categories', 'view announcements', 'view banners', 'view
	translations')
	<li class="side-nav-item">
	...
	@hasAnyPermission('view affiliates', 'view affiliate settings', 'view affiliate payouts', 'view affiliate
	users')
	<li class="side-nav-item">

...
@section('title', __('Patients Management'))
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0">{{ __('Patients Management') }}</h4>
            ...
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-header bg-success text-white">
                        <h5 class="mb-0"><i class="fas fa-user-injured"></i> {{ __('All Patients') }}</h5>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="patients-table" class="table table-bordered table-striped table-hover">
    ...
    <script>
        $(document).ready(function () {
            $('#patients-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('admin.users-management.patients.data') }}',
                columns: [
                    { data: 'id', name: 'id' },
                    { data: 'name', name: 'name' },
            ...
            $(document).on('click', '.btn-delete-patient', function () {
                ...
                Swal.fire({
                    ...
                    text: '{{ __('Do you want to delete this patient?') }}',
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '{{ route('admin.users-management.patients.destroy', ':id') }}'.replace(':id', id),
                            method: 'DELETE',

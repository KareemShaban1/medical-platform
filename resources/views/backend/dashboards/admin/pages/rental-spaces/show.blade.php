            ...
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <a href="{{ route('admin.rental-spaces.edit', $rentalSpace->id) }}" class="btn btn-primary me-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <table class="table table-borderless mb-0">
                                    <tbody>
                                        <tr>
                                            <th style="width: 40%;">{{ __('Clinic') }}:</th>
                                            <td>
                                                @if ($rentalSpace->clinic)
                                                    <a
                                                        href="{{ route('admin.users-management.clinic-details', $rentalSpace->clinic->id) }}">
                                                        {{ $rentalSpace->clinic->name }}
                                                    </a>
                                                @else
                                        ...
                                        <tr>
                                            <th>{{ __('Created') }}:</th>
                                            <td>{{ $rentalSpace->created_at->format('Y-m-d H:i') }}</td>
                                        </tr>
                                        <tr>
                                            <th>{{ __('Updated') }}:</th>
                                            <td>{{ $rentalSpace->updated_at->format('Y-m-d H:i') }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>

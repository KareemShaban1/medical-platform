                ...
                <div class="row" style="display: flex; align-items: center;">
                    ...
                    <!-- Content English -->
                     <div class="col-md-6 mb-3">
                        ...
                        <textarea name="content_en" id="content_en" class="form-control" required>{{ old('content_en') }}</textarea>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea name="content_ar" id="content_ar" class="form-control" required>{{ old('content_ar') }}</textarea>

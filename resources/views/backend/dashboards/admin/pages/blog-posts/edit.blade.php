...
@section('content')
    <div class="card mt-3">
        ...
        <div class="card-body p-4">
            <form action="{{ route('admin.blog-posts.update', $blogPost->id) }}" method="POST"
                    ...
                    <div class="row" style="display: flex; align-items: center;">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="title_en" id="title_en" class="form-control"
                                value="{{ $blogPost->title_en }}" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="title_ar" id="title_ar" class="form-control"
                                value="{{ $blogPost->title_ar }}" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <textarea name="content_en" id="content_en" class="form-control"
                                required>{{ $blogPost->content_en }}</textarea>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <textarea name="content_ar" id="content_ar" class="form-control"
                                required>{{ $blogPost->content_ar }}</textarea>

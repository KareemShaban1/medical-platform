                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <table class="table table-bordered">
                                        ...
                                        <td>
                                            @if ($clinic->approvement)
                                                @php
                                                    ...
                                                    $class = $badges[$clinic->approvement->action] ?? 'secondary';
                                                @endphp
                                                <span class="badge bg-{{ $class }}">
                                                    {{ ucfirst(str_replace('_', ' ', $clinic->approvement->action)) }}
                                                </span>
                                            @else
                                    ...
                                    @if ($clinic->approvement && $clinic->approvement->notes)
                                        <tr>
                                            <th>Notes:</th>
                                            <td>{{ $clinic->approvement->notes }}</td>
                                        </tr>
                                    @endif
                                </table>
                            </div>

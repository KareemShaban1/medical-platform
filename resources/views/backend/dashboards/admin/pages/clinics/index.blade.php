            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                        data-bs-target="#clinicsModal" onclick="resetForm()">
...
<!-- Add/Edit Modal -->
<div class="modal fade" id="clinicsModal" tabindex="-1" role="dialog" aria-labelledby="clinicsModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="clinicsModalLabel">{{ __('Add Clinic') }}</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"
                    aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="clinicsForm" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" id="clinicsId">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-3 mb-3">
                            <div class="form-check form-switch mt-4">
                                <input type="hidden" name="is_allowed"
                                    id="isAllowedHidden" value="0">
                                <input type="checkbox"
                                    class="form-check-input"
                                    id="isAllowedToggle" value="1">
...
<!-- show Modal -->
<div class="modal fade" id="showClinicModal" tabindex="-1" role="dialog" aria-labelledby="showClinicModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="showClinicModalLabel">{{ __('Show Clinic') }}</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"
                    aria-label="Close"></button>
            </div>
            <div class="modal-body">
...
@include('backend.dashboards.admin.pages.clinics.scripts')
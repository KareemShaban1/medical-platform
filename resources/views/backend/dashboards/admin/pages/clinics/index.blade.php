		...
		<div class="col-12">
			<div class="page-title-box">
				<div class="page-title-right">
					@hasPermission('create clinic')
					<button type="button" class="btn btn-primary" data-bs-toggle="modal"
						data-bs-target="#clinicsModal">
...
<!-- show Modal -->
<div class="modal fade" id="showClinicModal" tabindex="-1" role="dialog" aria-labelledby="showClinicModalLabel"
	aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">

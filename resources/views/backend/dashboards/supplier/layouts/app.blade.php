...
@include('backend.dashboards.supplier.layouts.head')
...
<body class="loading"
          ...
          <div class="wrapper">
                    ...
                    @include('backend.dashboards.supplier.layouts.sidebar')
                    <!-- ============================================================== -->
                    ...
                    <div class="content-page">
                              <div class="content">
                                        ...
                                        @include('backend.dashboards.supplier.layouts.top-bar')
          ...
          @include('backend.dashboards.supplier.layouts.footer-scripts')
          <!-- end demo js-->
</body>

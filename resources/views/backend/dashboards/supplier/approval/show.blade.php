    ...
    <div class="approval-overlay">
        <div class="approval-modal">
            <div class="modal-header-custom">
                <h3>Supplier Approval Status</h3>
            </div>
            ...
            <div class="modal-body-custom">
                    ...
                    <div class="documents-grid">
                        <div class="doc-item">
                            ...
                            <div class="doc-content">
                                ...
                                <div class="doc-description">Valid, up-to-date commercial register document</div>
                            </div>
                        </div>
                        ...
                        <div class="doc-item">
                            ...
                            <div class="doc-content">
                                <div class="doc-title">Tax Card</div>
                                <div class="doc-description">Clear scan of the official tax card</div>
                            </div>
                        </div>
                        ...
                        <div class="doc-item">
                            ...
                            <div class="doc-content">
                                <div class="doc-title">National ID (front &amp; back)</div>
                                <div class="doc-description">Front and back of the authorized representative ID</div>
                            </div>
                        </div>

                        <div class="doc-item">
                            <i class="fas fa-university doc-icon"></i>
                            <div class="doc-content">
                                <div class="doc-title">Bank Account / IBAN</div>
                                <div class="doc-description">Bank statement or document showing IBAN details</div>
                            </div>
                        </div>
                    </div>
                ...
                @elseif($status === 'under_review')
                    <div class="status-alert info">
                        ...
                        <div>
                            ...
                            <p class="mb-0 mt-1">Your supplier documents are being reviewed by our team. We'll notify you once the review is complete.</p>
                        </div>
                    </div>
                ...
                @elseif($status === 'approved')
                    <div class="status-alert success">
                        ...
                        <div>
                            ...
                            <p class="mb-0 mt-1">Your supplier application has been approved. You can now explore your dashboard.</p>
                        </div>
                    </div>
                @endif
                ...
                <div class="text-center mt-4">
                    ...
                    @if ($status === 'approved')
                        <a href="{{ route('supplier.dashboard') }}" class="btn btn-success ms-2">

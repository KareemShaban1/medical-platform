...
<body>
			...
			<div class="row g-0">
				...
				<div class="col-lg-5">
					<div class="form-image">
						<div class="form-image-content">
							...
							<h3>{{ __('Supplier Registration') }}</h3>
				...
				<div class="col-lg-7">
					<div class="form-content">
						<form method="POST" action="{{ Route('supplier.register-supplier') }}"
							...
							<div id="stepper">
								...
								<div class="step step-1 active">
									<div class="step-header">
										<h4>{{ __('Step 1: Supplier Information') }}
										</h4>
										<p>{{ __('Please provide your supplier details') }}
										</p>
									</div>
									...
									<div class="row">
										<div
											...
											<div
												class="form-group">
												<label
													class="form-label required">{{ __('Supplier Name') }}</label>
												<input type="text"
													name="supplier_name"
													id="supplier_name"
									...
									<div class="form-group">
										<label
											class="form-label">{{ __('Supplier Images') }}</label>
										<div
								...
								<div class="step step-2">
									<div class="step-header">
										...
										<p>{{ __('Create your admin account for the supplier') }}
										</p>
									</div>
	...
	@include('backend.dashboards.supplier.auth.scripts.register-scripts')

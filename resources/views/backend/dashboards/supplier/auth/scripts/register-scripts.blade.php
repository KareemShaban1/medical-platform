...
<script>
    ...
    $(document).ready(function() {
        ...
        function checkStepValidity(step) {
            let isValid = true;
            const stepFields = step === 1 ? ['supplier_name', 'phone', 'governorate_id', 'city_id', 'area_id',
                'address'
            ] : [

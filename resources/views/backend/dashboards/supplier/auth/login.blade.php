			...
			<div class="row g-0">
				...
				<div class="col-lg-5">
					<div class="form-image">
						<div class="form-image-content">
							...
							<p>{{ __('Sign in to your supplier account and manage your business') }}</p>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-7">
					<div class="form-content">
						<form method="POST" action="{{ Route('login') }}" id="supplierLoginForm">
							@csrf

							<div class="login-header">
								<h4>{{ __('Supplier Login') }}</h4>
							...
							<div class="form-group">
								...
								<div class="position-relative">
									...
									<button type="button" class="btn position-absolute" id="passwordToggle"
										style="top: 50%; right: 10px; transform: translateY(-50%); border: none; background: transparent; color: #6c757d; z-index: 10; padding: 0; width: 20px; height: 20px; display: flex; align-items: center; justify-content: center;">

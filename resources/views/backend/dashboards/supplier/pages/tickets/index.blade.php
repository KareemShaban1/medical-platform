                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a
                                    href="{{ route('supplier.dashboard') }}">{{ __('Dashboard') }}</a></li>
                            ...
                            <div class="tab-pane" id="new">
                                <form id="new-ticket-form" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <small class="text-muted">{{ __('Minimum 10, maximum 5000 characters') }}</small>
                                    </div>
                                    <div class="mb-3">
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#tickets-table').DataTable({
                ...
                ajax: '{{ route('supplier.tickets.data') }}',
                columns: [
            ...
            $('#new-ticket-form').on('submit', function (e) {
                e.preventDefault();
                $.ajax({
                    url: '{{ route('supplier.tickets.store') }}', method: 'POST',
                    ...
                    error: function (xhr) {
                        ...
                        if (e) Object.keys(e).forEach(k => toastr.error(e[k][0]));
                        else toastr.error(xhr.responseJSON?.message || '{{ __('Error') }}');
                    }
                });
            });
        });

...
<head>
    <title>{{ __('Forgot Password - Clinic') }}</title>
    <meta charset="UTF-8">
                    ...
                    <div class="form-content">
                        ...
                        <div id="step1" class="step-content">
                            ...
                            <div class="text-center mt-4">
                                <a href="{{ url('/clinic/login') }}" class="btn btn-link">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#sendOtpBtn').on('click', function () {
                ...
                $.ajax({
                    url: '{{ route("clinic.forgot-password.send") }}',
                    type: 'POST',
                    data: {
                        email: email,
            ...
            $('#verifyOtpBtn').on('click', function () {
                ...
                $.ajax({
                    url: '{{ route("clinic.forgot-password.verify") }}',
                    type: 'POST',
                    data: {
                        user_id: userId,
                        otp: otp,
            ...
            $('#resendOtpBtn').on('click', function () {
                ...
                $.ajax({
                    url: '{{ route("clinic.forgot-password.resend") }}',
                    type: 'POST',
                    data: {
                        user_id: userId,
                        _token: $('meta[name="csrf-token"]').attr('content')
            ...
            $('#resetPasswordBtn').on('click', function () {
                ...
                $.ajax({
                    url: '{{ route("clinic.forgot-password.reset") }}',
                    type: 'POST',
                    data: {

...
<div class="container-fluid">
	<div class="d-flex justify-content-between align-items-center mb-3">
		...
		@hasPermission('create lab order')
		<a href="{{ route('clinic.lab-orders.create') }}"
			class="btn btn-primary">{{ __('Create Lab Order') }}</a>
		@endhasPermission
	</div>
	...
	<div class="card">
		<div class="card-body">
			<div class="row g-2 mb-3">
				...
				<div class="col-md-3"><input type="date" id="filter-from"
						class="form-control" /></div>
				<div class="col-md-3"><input type="date" id="filter-to" class="form-control" />
				</div>
			</div>

...
<div class="card mt-3">
	<div class="card-header">
		<h4 class="card-title">{{ __('Edit Prescription') }}</h4>
	</div>

	<div class="card-body p-4">
		<form action="{{ route('clinic.prescriptions.update', $prescription->id) }}" method="POST"
				...
				<div class="col-md-7 mb-4 border p-3 rounded">
					...
					<div class="mb-3">
						...
						<textarea name="notes" id="notes"
							class="form-control"
							required>{{ old('notes', $prescription->notes) }}</textarea>
						@error('notes') <span

    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">{{ __('Create Doctor Profile') }}</h4>
            </div>
        </div>
    </div>

    <form id="profileForm" action="{{ route('clinic.doctor-profiles.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <!-- Basic Information -->
            <div class="col-lg-8">
            ...
            <div class="col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="invalid-feedback"></div>
                        <small class="text-muted">{{ __('Upload profile photo (max 2MB)') }}</small>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label for="twitter_link" class="form-label">
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewBox="0 0 16 16" class="d-inline-block align-text-bottom"><path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z"/></svg> {{ __('X') }}
                            </label>
    ...
    $.ajax({
        ...
        success: function(response) {
            Swal.fire('Success', response.message, 'success')
                .then(() => window.location.href = '{{ route("clinic.doctor-profiles.index") }}');
        },
        error: function(xhr) {
            if (xhr.status === 422) {

        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <a href="{{ route('clinic.availability-overrides.trash') }}" class="btn btn-warning me-2">
...
let table = $('#overrides-table').DataTable({
    ...
    buttons: [
        ...
        { extend: 'excel', text: 'Excel', title: 'Availability Overrides Data', exportOptions: { columns: [0, 1, 2, 3, 4, 5] } },
...
$('#overrideForm').on('submit', function(e) {
    ...
    let url = id ?
        '{{ route("clinic.availability-overrides.update", ":id") }}'.replace(':id', id) :
...
function deleteOverride(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: '{{ route("clinic.availability-overrides.destroy", ":id") }}'.replace(':id', id),
                method: 'DELETE',

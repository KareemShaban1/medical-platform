    ...
    <div class="approval-overlay"
        ...
        <div class="approval-modal"
            ...
            <div class="text-center mb-4">
                <h3 class="mb-3">Clinic Approval Status</h3>

                @if ($status === 'pending')
                    <div class="alert alert-warning">
                        <i class="fas fa-clock"></i>
                        <strong>Action Required:</strong> Please upload your clinic documents for approval.
                    </div>
                @elseif($status === 'under_review')
                    <div class="alert alert-info">
                        <i class="fas fa-search"></i>
                        <strong>Under Review:</strong> Your clinic documents are being reviewed by our team. We'll notify
                        you once the review is complete.
                    </div>
                @elseif($status === 'rejected')
                    <div class="alert alert-danger">
                        <i class="fas fa-times-circle"></i>
                        <strong>Rejected:</strong> Your clinic application has been rejected.
                ...
                @elseif($status === 'approved')
                    <div class="alert alert-success">
                        ...
                        <strong>Approved:</strong> Your clinic application has been approved you can now explore your dashboard.
                    </div>
                @endif
            </div>
            ...
            <div class="text-center mt-3">
                ...
                @if ($status === 'approved')
                    <a href="{{ route('clinic.dashboard') }}" class="btn btn-success">

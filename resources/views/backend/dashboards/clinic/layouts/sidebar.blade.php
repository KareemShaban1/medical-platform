...
<div class="leftside-menu">
	...
	<div class="h-100" id="leftside-menu-container" data-simplebar="">
		...
		<ul class="side-nav">
			...
			<!-- Clinic Management -->
			<li class="side-nav-item">
				<a data-bs-toggle="collapse" href="#sidebarClinicinventories" aria-expanded="false"
					aria-controls="sidebarClinicinventories" class="side-nav-link">
					<!-- inventories icon -->
			...
			<li class="side-nav-item">
				<a data-bs-toggle="collapse" href="#sidebarExpenseCategories" aria-expanded="false"
					aria-controls="sidebarExpenseCategories" class="side-nav-link">
					<i class="uil-file-medical"></i>
				...
				<div class="collapse" id="sidebarExpenseCategories">
					<ul class="side-nav-second-level">
						...
						<li>
							<a href="{{ route('clinic.expense-categories.index') }}">
			...
			<!-- Support Tickets -->
			<li class="side-nav-item">
				<a href="{{ route('clinic.tickets.index') }}" class="side-nav-link">

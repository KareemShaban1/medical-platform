@props(['position' => null, 'pageIdentifier' => null])
...
$pageIdentifier = $pageMap[$routeName] ?? $routeName ?? 'home';
}

// Get banners for this section position
...
<div class="container mx-auto section-ad-container my-8">
	...
	<div class="swiper section-ad-swiper" style="width: 100%;">
		...
		<div class="swiper-button-next"
			style="color: white; background: rgba(0,0,0,0.5); border-radius: 50%; width: 40px; height: 40px;">
		</div>

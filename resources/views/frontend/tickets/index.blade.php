        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-sm">
                ...
                <div id="new-content" class="tab-content p-6 hidden">
                    <form id="new-ticket-form" method="POST" action="{{ route('user.tickets.store') }}"
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                <label for="type"
                                    class="block text-sm font-medium text-gray-700 mb-2">{{ __('Ticket Type') }} <span
                                ...
                                @if($ticketTypes->isEmpty())
                                    <p class="mt-1 text-sm text-red-500">
                                        {{ __('No ticket types available for your account type.') }}</p>
                                @endif
                            </div>
                            ...
                            <div>
                                <label for="details"
                                    class="block text-sm font-medium text-gray-700 mb-2">{{ __('Details') }} <span
                                        class="text-red-500">*</span></label>
                                ...
                                <p class="mt-1 text-sm text-gray-500">
                                    {{ __('Minimum 10 characters, maximum 5000 characters') }}</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-500">
                                    {{ __('You can upload up to 5 files. Allowed formats: JPEG, PNG, GIF, PDF, DOC, DOCX. Max size: 2MB per file.') }}
                                </p>
                            </div>
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.status === 'success') {
                            ...
                            // Switch to submitted tickets tab
                            $('#submitted-tab').click();
                            // Reload table
                    ...
                    error: function (xhr) {
                        ...
                        if (errors) {
                            ...
                            let message = xhr.responseJSON?.message || '{{ __('Something went wrong') }}';
                            if (typeof toastr !== 'undefined') {

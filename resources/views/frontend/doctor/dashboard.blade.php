				...
				<div class="p-8">
					...
					<div class="text-center mb-10">
						...
						<p class="text-gray-500">
							{{ __('Welcome to your doctor dashboard') }}
						</p>
					</div>
						...
						@php
							$features = [
								[
									...
									'title' =>
										__('Doctor Profile'),
									'desc' => __('Create and manage your doctor profile'),
									'route' => route('doctor.profile.index')
								],
								[
									...
									'title' =>
										__('My Orders'),
									'desc' => __('View your orders from the website'),
									'route' => route('doctor.orders.index')
								],
								[
									...
									'title' =>
										__('Courses'),
									'desc' => __('View your enrollments and access links'),
									'route' => route('doctor.courses.index')
								],
								[
									'icon' => 'fa-credit-card',
									...
									'title' =>
										__('My Subscription'),
									'desc' => __('View subscription details and usage'),
									'route' => route('doctor.subscriptions.index')
								],
								[
									'icon' => 'fa-headset',
									'color' => 'text-red-500',
									...
									'route' => route('doctor.tickets.index')
								],
							];
						@endphp
						...
						<div>
							...
							<ul class="space-y-1 text-gray-600">
								<li>
									...
									<span class="ml-2 px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-medium">

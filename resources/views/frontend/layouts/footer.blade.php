	...
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
			...
			<div>
				...
				<ul class="space-y-2">
					<li><a href="#" class="text-gray-400 hover:text-white transition">About
							Us</a></li>
					<li><a href="#"
							class="text-gray-400 hover:text-white transition">Services</a>
					</li>
					<li><a href="{{ route('clinics') }}"
							class="text-gray-400 hover:text-white transition">Clinics</a>
					</li>
					<li><a href="{{ route('suppliers') }}"
							class="text-gray-400 hover:text-white transition">Suppliers</a>
					</li>
				</ul>
			</div>
			<div>
			...
			<div>
				...
				<ul class="space-y-2 text-gray-400">
					...
					<li><i class="fas fa-envelope mr-2"></i>
						info@medicalplatform.com</li>
					<li><i class="fas fa-map-marker-alt mr-2"></i> 123
						Medical
						St, City, State</li>
				</ul>
			</div>

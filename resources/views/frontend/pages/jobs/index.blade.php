...
<section class="py-12 bg-gray-50 relative overflow-hidden">
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
		...
		<!-- Jobs Grid with Advanced Animations -->
		<div id="jobsGrid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
			@include('frontend.pages.jobs.partials.jobs-grid', ['jobs' => $jobs])
		</div>
...
@include('frontend.pages.jobs.scripts.index-js')

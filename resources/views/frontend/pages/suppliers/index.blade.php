		...
		<div class="max-w-2xl mx-auto animate-fade-in-up animation-delay-400">
			<div class="relative group">
				<input type="text" id="heroSearch"
					placeholder="{{ __('search for suppliers') }}"
	...
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
		...
		<div id="filtersPanel" class="hidden bg-gray-50 rounded-2xl p-6 shadow-lg border border-gray-200">
			<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
				...
				<div class="group">
					<label
						class="block text-sm font-semibold text-gray-700 mb-3">{{ __('search suppliers') }}</label>
					<div class="relative">
...
<section class="py-12 bg-gray-50 min-h-screen">
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
		...
		<!-- Enhanced Pagination -->
		<x-frontend.pagination :paginator="$suppliers" container-class="mt-12" :show-info="true"

...
@section('title', __('Medical Suppliers'))
@push('styles')
	<style>
		/* Custom Animations */
		@keyframes fadeInUp {
		...
		<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
			...
			<div id="filtersPanel" class="hidden bg-gray-50 rounded-2xl p-6 shadow-lg border border-gray-200">
				<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
					<!-- Search Filter -->
					<div class="group">
						<label class="block text-sm font-semibold text-gray-700 mb-3">{{ __('search suppliers') }}</label>
						<div class="relative">
							<input type="text" id="search" placeholder="{{ __('search suppliers') }}"
					...
					<!-- governorate filter -->
					<div class="group">
						<label class="block text-sm font-semibold text-gray-700 mb-3">{{ __('governorate') }}</label>
						<div class="relative">
					...
					<!-- city filter -->
					<div class="group">
						<label class="block text-sm font-semibold text-gray-700 mb-3">{{ __('city') }}</label>
						<div class="relative">
							<select id="city_id"
								class="form-input w-full px-3 py-3 group-hover:scale-105 transition-transform duration-300">
					...
					<!-- area -->
					<div class="group">
						<label class="block text-sm font-semibold text-gray-700 mb-3">{{ __('area') }}</label>
						<div class="relative">
							<select id="area_id"
								class="form-input w-full px-3 py-3 group-hover:scale-105 transition-transform duration-300">
		...
		<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
			...
			<div id="loadingSpinner" class="hidden text-center py-12">
				<div class="inline-flex items-center space-x-3">
					...
					<span class="text-gray-600 font-medium">{{ __('loading suppliers') }}</span>
				</div>
			</div>

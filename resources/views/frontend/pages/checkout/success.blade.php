...
<div class="container mx-auto px-4 py-8">
	<div class="max-w-3xl mx-auto">
		...
		<div class="bg-green-50 border-2 border-green-500 rounded-lg p-8 text-center mb-6">
			...
			<h1 class="text-3xl font-bold text-green-700 mb-2">Order Placed
				Successfully!</h1>
			<p class="text-gray-700">Thank you for your order. We'll process it
				shortly.</p>
		</div>

		<!-- Order Details -->
		<div class="bg-white rounded-lg shadow-md p-6 mb-6">
			<h2 class="text-2xl font-bold mb-4 text-gray-900">Order Details</h2>
			...
			<!-- Order Items -->
			<h3 class="text-xl font-bold mb-3 text-gray-900">Items Ordered</h3>
			<div class="space-y-3">
		...
		<div class="flex gap-4">
			<a href="{{ route('products') }}"
				class="flex-1 text-center px-6 py-3 bg-blue-700 text-white font-semibold rounded-lg hover:bg-blue-800">
				Continue Shopping
			</a>
			<a href="{{ route('home') }}"
				class="flex-1 text-center px-6 py-3 bg-gray-200 text-gray-900 font-semibold rounded-lg hover:bg-gray-300">
				Go to Home
			</a>
		</div>
	</div>

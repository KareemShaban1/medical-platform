...
<body>
				...
				<div class="col-lg-5">
					<div class="form-image">
						<div class="form-image-content">
							...
							<p>{{ __('Create your patient account and get access to quality healthcare services') }}
							</p>
						</div>
					</div>
				</div>
					...
					<div class="form-content">
						<form method="POST" action="{{ route('register') }}"
							...
							<div class="login-header">
								<h4>{{ __('Patient Registration') }}
								</h4>
								<p>{{ __('Please fill in your information to create an account') }}
								</p>
							</div>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label
											class="form-label required">{{ __('Full Name') }}</label>
										<input type="text"
											name="name"
											id="name"
							...
							<div class="text-center mt-4">
								<p>{{ __("Already have an account?") }}
									<a
										href="{{ url('/patient/login') }}">{{ __('Sign in here') }}</a>
								</p>
							</div>
	...
	$(document).ready(function() {
		...
		$('#passwordToggle, #passwordConfirmToggle').on('click', function() {
			const isPasswordField = $(this).attr('id') ===
				'passwordToggle';
			const passwordField = isPasswordField ? $('#password') : $(
		...
		$('#patientRegistrationForm').on('submit', function(e) {
			...
			if (!name) {
				...
				showFieldError('name',
					'{{ __("Name must be at least 2 characters") }}'
					);
				isValid = false;
			}

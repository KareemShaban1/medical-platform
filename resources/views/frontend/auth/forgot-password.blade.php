...
<head>
    <title>{{ __('Forgot Password - Patient') }}</title>
    <meta charset="UTF-8">
                    ...
                    <div class="form-content">
                        ...
                        <div id="step1" class="step-content">
                            ...
                            <div class="text-center mt-4">
                                <a href="{{ url('/patient/login') }}" class="btn btn-link">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#sendOtpBtn').on('click', function () {
                ...
                $.ajax({
                    url: '{{ route("patient.forgot-password.send") }}',
                    type: 'POST',
                    data: {
                        email: email,
            ...
            $('#verifyOtpBtn').on('click', function () {
                ...
                $.ajax({
                    url: '{{ route("patient.forgot-password.verify") }}',
                    type: 'POST',
                    data: {
                        user_id: userId,
                        otp: otp,
            ...
            $('#resendOtpBtn').on('click', function () {
                ...
                $.ajax({
                    url: '{{ route("patient.forgot-password.resend") }}',
                    type: 'POST',
                    data: {
                        user_id: userId,
                        _token: $('meta[name="csrf-token"]').attr('content')
            ...
            $('#resetPasswordBtn').on('click', function () {
                ...
                $.ajax({
                    url: '{{ route("patient.forgot-password.reset") }}',
                    type: 'POST',
                    data: {

    ...
    protected function seedForClinic(Clinic $clinic): void
    {
        ...
        $roles = [
            ...
            'doctor' => [
                ...
                'create invoice',
                'update invoice',
                'view availability overrides',
                'create availability override',
                'update availability override',
                'delete availability override',
                'view doctor availability overrides',
                'view daily periods',
                'view daily period appointments',
                'toggle daily period open',
                'update daily period capacity',
                'view subscriptions',
            ...
            'inventory-manager' => [
                'view dashboard',
                'view clinic inventories',
                'create clinic inventory',
                'update clinic inventory',
                'delete clinic inventory',
                'view clinic inventory movements',
                'create clinic inventory movement',
                'update clinic inventory movement',
                'delete clinic inventory movement',
            ...
            'hr-manager' => [
                ...
                'view job application fields',
                'create job application field',
                'update job application field',
                'delete job application field',
                'view attendance',
                'approve attendance',
                'approve check in',
                'approve check out',
                ...
                'update working hour',
                'delete working hour',
                'bulk save working hours',
                'view user working hours',
                'view salary contracts',
                'create salary contract',
                'update salary contract',
                'view payslips',

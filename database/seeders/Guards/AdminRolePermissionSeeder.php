    ...
    public function run(): void
    {
        ...
        $permissionGroups = [
            ...
            'Affiliates' => [
                ...
                'view trash affiliate users',
                'restore affiliate user',
                'force delete affiliate user',
            ],

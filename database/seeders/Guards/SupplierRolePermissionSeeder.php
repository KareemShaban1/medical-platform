    ...
    protected function seedForSupplier(Supplier $supplier): void
    {
        ...
        $roles = [
            ...
            'supplier-manager' => [
                ...
                'view products', 'create product', 'update product', 'delete product', 'toggle product status',
                ...
                'view specialized categories', 'create specialized category', 'update specialized category', 'delete specialized category', 'attach specialized category',
            ...
            'supplier-staff' => [
                'view dashboard',
                'view users',
                'view products', 'create product', 'update product',
                'view offers', 'create offer', 'update offer',
                'view available requests', 'create offer for request',

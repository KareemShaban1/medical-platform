...
class RoleRepository implements RoleRepositoryInterface
{
    ...
    public function index()
    {
        ...
        return view('backend.dashboards.admin.pages.roles.index', compact('roles', 'permissions'));
    }
    ...
    {
        $permissions = Permission::where('guard_name', $this->guard)->get();
        return view('backend.dashboards.admin.pages.roles.create', compact('permissions'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.dashboards.admin.pages.roles.edit', compact('role', 'permissions'));
    }
    ...
    public function destroy($id)
    {
        return DB::transaction(function () use ($id) {
            ...
            return redirect()->route('admin.roles.index')->with('success', __('Role moved to trash successfully'));
        });
    }

    public function trash()
    {
        return view('backend.dashboards.admin.pages.roles.trash');
    }
    ...
    public function restore($id)
    {
        return DB::transaction(function () use ($id) {
            ...
            return redirect()->route('admin.roles.index')->with('success', __('Role restored successfully'));
        });
    }
    ...
    public function forceDelete($id)
    {
        return DB::transaction(function () use ($id) {
            ...
            return redirect()->route('admin.roles.trash')->with('success', __('Role permanently deleted successfully'));
        });
    }

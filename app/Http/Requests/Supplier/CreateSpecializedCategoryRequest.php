...
class CreateSpecializedCategoryRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'name_en' => 'required|string|min:2|max:100|unique:supplier_specialized_categories,name_en',
            'name_ar' => 'required|string|min:2|max:100|unique:supplier_specialized_categories,name_ar',
        ];
    }

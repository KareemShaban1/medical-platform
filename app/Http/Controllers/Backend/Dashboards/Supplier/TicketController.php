...
class TicketController extends Controller
{
    ...
    {
        $ticketTypes = TicketType::active()->forUserType('supplier_user')->get();
        return view('backend.dashboards.supplier.pages.tickets.index', compact('ticketTypes'));
    }
    ...
    public function data()
    {
        ...
        return datatables()->of($tickets)
            ...
            ->addColumn('action', fn($item) => '<a href="' . route('supplier.tickets.show', $item->id) . '" class="btn btn-sm btn-primary"><i class="mdi mdi-eye"></i></a>')
    ...
    public function show($id)
    {
        ...
        return view('backend.dashboards.supplier.pages.tickets.show', compact('ticket'));
    }

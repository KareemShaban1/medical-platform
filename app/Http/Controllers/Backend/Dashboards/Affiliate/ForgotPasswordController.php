...
class ForgotPasswordController extends Controller
{
    ...
    {
        return view('backend.dashboards.affiliate.auth.forgot-password');
    }
    ...
    public function sendResetOtp(Request $request)
    {
        ...
        try {
            ...
            // Send notification
            $user->notify(new PasswordResetNotification($otp, 'affiliate'));
    ...
    public function verifyOtp(Request $request)
    {
        ...
        try {
            $user = AffiliateUser::findOrFail($request->user_id);
    ...
    public function resetPassword(Request $request)
    {
        ...
        try {
            ...
            $user = AffiliateUser::findOrFail($userId);
            ...
            return response()->json([
                ...
                'redirect_url' => url('/affiliate/login')
            ]);
        } catch (\Exception $e) {
            DB::rollBack();
            return response()->json([

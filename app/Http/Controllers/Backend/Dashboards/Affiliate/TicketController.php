...
class TicketController extends Controller
{
    ...
    {
        return auth('affiliate')->user();
    }

    public function index()
    {
        $ticketTypes = TicketType::active()->forUserType('affiliate_user')->get();
        return view('backend.dashboards.affiliate.pages.tickets.index', compact('ticketTypes'));
    }
    ...
    public function data()
    {
        ...
        return datatables()->of($tickets)
            ...
            ->addColumn('action', fn($item) => '<a href="' . route('affiliate.tickets.show', $item->id) . '" class="btn btn-sm btn-primary"><i class="mdi mdi-eye"></i></a>')
    ...
    public function show($id)
    {
        ...
        return view('backend.dashboards.affiliate.pages.tickets.show', compact('ticket'));
    }
